...
//     if (request.action === 'readHeadings') {
...
//     if (message.action === 'readHeadings') {
//         const updatedUrl = message.url;  // get the URL from the message
//         console.log('Received readHeadings message:', updatedUrl);
//         // Do something with the URL
//         if (updatedUrl.includes('mathplanet.com')) {
//             console.log('mathplanet website was opened');
//             chrome.runtime.sendMessage({ action: 'callReadtextFile', filename: 'Text_com/mathplanet_links.txt' });
