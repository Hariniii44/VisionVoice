...
filename_to_read = "3_1.jpg"   # this is where the image will be called when user asks to explain image

# Define the directory containing the files
image_dir = "C:/Users/Tharanesh/Desktop/Google Translate for SDGP"
